...
const MOCK_RESPONSE = {
  ...
  judge: {
    solution_1_score: 10,
    solution_2_score: 5,
    solution_1_feedback: "Excellent, optimal solution. Space complexity is O(1) which is perfect for this problem.",
    solution_2_feedback: "The recursive approach without memoization is extremely slow for large inputs."
  }
};
